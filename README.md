...
| ------------- | ------------- | ------------- | ------------- | ------------- | ------------- | ------------- |------------- |
| Intrinsic Method | - | - | - | - | - | - |
| CoVe (2023) | (Junran Wu)Intrinsic | [arXiv](https://arxiv.org/abs/2309.11495) | MultiSpanQA， longform text generation | Wikidata API， | Llama 65B | [代码仓库](https://github.com/lastmile-ai/aiconfig/blob/main/cookbooks/Chain-of-Verification/README.md?plain=1) | 202 |
| CAI Revisions (2022) | (Junran Wu)Intrinsic | [arXiv](https://arxiv.org/abs/2212.08073) | QA,textbased conversations | [HHH](https://paperswithcode.com/dataset/hhh) | 52B | [代码仓库](https://github.com/anthropics/ConstitutionalHarmlessnessPaper?utm_source=catalyzex.com) | 952 |
| Self-Refine (2023) | (Junran Wu)Intrinsic | [arXiv](https://arxiv.org/abs/2303.17651) | 1.Sentiment Reversal,    2.Dialogue Response,  3.Code Optimization,  4.Code Readability, 5.Math Reasoning,6.Acronym Generation,7.Constrained Generation |  1.arXiv:1509.01626;2. Unsupervised Evaluation of Interactive Dialog with DialoGPT; 3.arXiv:2302.07867;4.arXiv:2105.12655;5.arXiv:2110.14168;6.Appendix Q;7.	arXiv:1911.03705| GPT-3.5, GPT-4 | [代码仓库](https://github.com/madaan/self-refine) | 879 |
...
| FLARE (2023) | - | [arXiv](https://arxiv.org/abs/2305.06983) | - | - | GPT-3 | [CODE](https://github.com/jzbjyb/FLARE) | 311 |
| ------------- | ------------- | -------------| ------------- | ------------- | ------------- | ------------- |------------- |
| Fine-tuning Method | - | - |  - | - | - | - | - |
...
| DCOT (2024) | (Ruihang Zhang)Fair-Asym | [arXiv](https://arxiv.org/pdf/2407.03181) |High-School Science,Logic,State-tracking,Conditional,Math,Explicit multli-hop,Symbolic Relationships,Implicit multi-hop | ARC,BGQA,CoinFlip,CondQA,GSM8K,HotpotQA,LLC,Quartz,StrategyQA | Phi 1.5 (1.3B),Phi 2 (2.7B), LLaMA-2 7B,LLaMA-2 13B,LLaMA2 13B Chat,LLaMA2 70B* | [代码仓库](https://github.com/UKPLab/arxiv2024-divergent-cot?tab=readme-ov-file) | - |
