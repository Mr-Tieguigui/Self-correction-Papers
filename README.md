...
| Self-Refine (2023) | (Junran Wu)Intrinsic | [arXiv](https://arxiv.org/abs/2303.17651) | Sentiment Reversal,Dialogue Response,Code Optimization,Code Readability,Math Reasoning,Acronym Generation,Constrained Generation | - | GPT-3.5, GPT-4 | [代码仓库](https://github.com/madaan/self-refine) | 789 |
